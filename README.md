...
| **edgelab-knowledge-search** | Поиск по библиотеке сообщества (навыки, уроки, дропы, дайджесты, категории) из терминала через `curl`/JSON-RPC, без MCP-клиента. | [`skills/cli-knowledge-search/`](skills/cli-knowledge-search/) |

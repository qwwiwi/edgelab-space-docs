...
Сейчас **1990 ₽/мес** (далее 2990 ₽/мес), либо **год за 14990 ₽**. Чем раньше
зайдёшь — тем ниже зафиксируешь цену. Текущую цену и число занятых мест отдаёт
публичный эндпоинт:

```
GET https://api.edgelab.space/cohort-status
→ { "price_monthly": 1990, "next_price_monthly": 2990, "seats_left": …, "price_yearly": 14990 }
```
